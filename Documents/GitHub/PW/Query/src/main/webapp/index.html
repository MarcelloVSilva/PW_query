...
<body>
          ...
          <div id="dropdown-menu-registro" class="dropdown-menu" style="padding: 15px; padding-bottom: 0px;">
            <form action="[YOUR ACTION]" method="post" accept-charset="UTF-8">
            	<input id="user_name" style="margin-bottom: 15px;" type="text" name="user[name]" size="30" placeholder="Nome" />
				  <input id="user_username" style="margin-bottom: 15px;" type="text" name="user[username]" size="30" placeholder="Usuário" />
		...
		<div id='nav'>
	 	...
	 	<div id="new_qst">
            <form action="[YOUR ACTION]" method="post" accept-charset="UTF-8">
				  ...
				  <textarea id="desc_qst" rows="2" style="margin-left: 50px;margin-top: 5px; width:700px; max-width:700px; max-heigth: 100px;" type="text" name="descricao[pergunta]" placeholder="Descrição"></textarea>
	...
	<div id="corpo">
		<div id="questao" class="list-group-item">
			...
			<label>Já tentei de várias formas, porém sempra dá um erro de porta...</label>
		</div>
		<div id="questao" class="list-group-item">
			<img alt="30px" src="./img/query.png">
			<a href="#">Como fazer app com maven?</a></br>
	...
	<!--  <footer>Licença: GGMG / Versão: 1.0.0.1</footer>-->
</body>
</html>